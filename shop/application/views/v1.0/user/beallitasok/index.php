    ...
    <div class="grid-row grid-row-80 settings">
        ...
        <div class="form-rows">
            <form action="#alapadat" method="post">
                ...
                <? endif; ?>
                <div class="row np">
                    <div class="col-md-12 right"><button name="saveDefault" class="btn btn-pr btn-sm"><i class="fa fa-save"></i> Változások mentése</button></div>
                </div>
            </form>
        </div>
        ...
        <div class="form-rows">
            <form action="#ceg" method="post">
                ...
                <div class="row np">
                    <div class="col-md-12 right"><button name="saveCompany" class="btn btn-pr btn-sm"><i class="fa fa-save"></i> Változások mentése</button></div>
                </div>
            </form>
        </div>
        <? endif; ?>
        ...
        <div class="form-rows">
            ...
            <? endforeach; ?>
            <div class="row np">
                <div class="col-md-12 right"><button name="saveSzallitasi" class="btn btn-pr btn-sm"><i class="fa fa-save"></i> Változások mentése</button></div>
            </div>
            </form>
        </div>
        ...
        <div class="form-rows">
            ...
            <? endforeach; ?>
            <div class="row np">
                <div class="col-md-12 right"><button name="saveSzamlazasi" class="btn btn-pr btn-sm"><i class="fa fa-save"></i> Változások mentése</button></div>
            </div>
            </form>
        </div>
    </div>

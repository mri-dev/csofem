...
<div class="editForm create-product">
	<div class="row">
		...
		<div class="col-md-8" style="padding-left:0;">
				...
				<div class="con">
					<h3>Iroda Plusz - ügyviteli rendszer törzsadatok</h3>
					<div class="row">
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-8">
									...
									<input type="text" readonly="readonly" name="crm[termek_nev]" id="crm_termek_nev" value="<?=$this->termek[crm][termek_nev]?>" class="form-control">
								</div>
								<div class="col-md-4">
									<label for="crm_keszlet_min">Készlet</label>
									<input type="number" readonly="readonly"  min="0" step="0.1" name="crm[termek_keszlet]" id="crm_keszlet_min" value="<?=$this->termek[crm][termek_keszlet]?>" class="form-control">
								</div>
							</div>
							<br>
							<div class="row">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="row">
										<div class="col-md-12">
											<label for="crm_beszerzes_netto">Nettó alapár</label>
											<input type="number" min="0" step="0.1" disabled="disabled" id="crm_kisker_ar_netto" value="<?=$this->termek[crm][kisker_ar_netto]?>" class="form-control">
										</div>
									</div>
									<br>
									...
									<div class="row">
										<div class="col-md-6">
											<label for="crm_ar<?=$ap?>">Ár #<?=$ap?> bruttó <? if(array_key_exists('ar'.$ap, $this->price_groups)): ?>- <strong style="color:green;"><?=$this->price_groups['ar'.$ap]['title']?></strong><? endif; ?></label>
											...
											<div class="input-group">
												...
												<div class="input-group-addon">
													<?=(!array_key_exists('ar'.$ap, $this->price_groups)) ? '' : 'nettó '.Helper::cashFormat((round($this->termek[crm]['ar'.$ap] / 1.27))).' Ft'?>
												</div>
											</div>
											<small><?=(!array_key_exists('ar'.$ap, $this->price_groups)) ? 'Nincs árcsoporthoz kapcsolva. <a href="/arcsoportok">Beállítás</a>' : ''?></small>
										</div>
										<div class="col-md-6">
											<label for="crm_ar<?=$ap?>">Ár #<?=$ap?> akciós bruttó</label>
											<div class="input-group">
												...
												<div class="input-group-addon">
													<?=(!array_key_exists('ar'.$ap, $this->price_groups)) ? '' : 'nettó '.Helper::cashFormat((round($this->termek[crm]['ar'.$ap.'_akcios'] / 1.27))).' Ft'?>
												</div>
											</div>
										</div>
									</div>
